	...
	return (
		<>
			...
			<div className="h-screen bg-gradient-to-br from-secondary via-transparent">
				<div className="nav">
					<h1 className="logo text-7xl font-medium m-0">Colloquy</h1>
					<h3 className="text-2xl italic text-themeDarkBlue mt-4 ml-14">Start the conversation</h3>
				</div>
				<div className="ml-72 w-min pt-0">
					<img className="splash hidden xl:block" src='/assets/flat_background.svg'></img>
					<div
